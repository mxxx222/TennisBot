...
# Tennis AI - ROI-Optimized Pipeline
# Ajaa: pre-filter → AI analyzer → bet list generator
...
echo "🎾 TENNIS AI - ROI-OPTIMIZED PIPELINE"
echo "====================================="
echo ""
...
if [ -z "$NOTION_TOKEN" ] && [ -z "$NOTION_API_KEY" ]; then
    ...
    echo "   See: https://www.notion.so/Setup-Checklist-Notion-Integration-29bb397186e945aa87baba6bc15323c0"
else
...
echo "   - data/tennis_ai/ai_analysis_results.json (AI recommendations)"
