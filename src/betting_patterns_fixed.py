...
class BettingPattern(ABC):
    ...
    def __init__(self):
        """Initialize pattern with required attributes"""
        self.expected_hitrate = 0.0  # Must be overridden by subclasses
        self.odds_range = (1.0, 2.0)  # Must be overridden by subclasses
